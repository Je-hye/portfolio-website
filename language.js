(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "100% J": "100% J",
    "Planner by nature. In my last year of high school, I turned daily study hours into a shared group-chat habit with my tutoring classmates — and ended up studying 12–15 hours a day.": "타고난 계획형입니다. 고3 때 매일 공부 시간을 과외 친구들과 공유하는 단톡방 습관을 만들었고, 그 뒤로 하루 12~15시간씩 공부했습니다.",
    ...
    "Tutored the Python-based course I'd earned an A+ in myself.": "본인이 A+를 받았던 파이썬 기반 과목의 튜터로 활동했습니다.",
    ...
    "Analyzed 2D evaluation experiment logs across all four codecs to surface worst-case behavior.": "4개 코덱 전반의 2D 평가 실험 로그를 분석해 Worst-Case를 찾아냈습니다.",
    "Log analysis": "로그 분석",
    ...
    "S-Grade": "S등급",
    "Rated top-tier by the Korean Institute of Information Scientists and Engineers — with researchers from NVIDIA, Adobe, Google, and Disney regularly presenting.": "한국정보과학회 우수학술대회 평가에서 최고 등급인 S등급으로 분류되며, NVIDIA·Adobe·Google·Disney 등의 연구자들이 활발히 참여합니다.",
