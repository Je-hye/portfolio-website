(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "Used ProcessPoolExecutor instead of threads for CPU-bound encoding, then processed completed jobs asynchronously to reduce idle time.": "CPU 중심 인코딩에 스레드 대신 ProcessPoolExecutor를 적용하고, 완료된 작업부터 비동기로 처리해 유휴 시간을 줄였습니다.",
