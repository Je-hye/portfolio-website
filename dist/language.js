(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "Working under my advisor's direction, I selected and visualized worst-case results for the CODiff and DiQP restoration models across four codecs and QP conditions, then wrote a pipeline to auto-aggregate benchmark results — catching an anomalous log along the way.": "지도교수님 지시에 따라 CODiff·DiQP 복원 모델의 worst-case를 4개 코덱·다양한 QP 조건에서 선별·시각화하고, 벤치마크 결과를 자동 집계하는 파이프라인을 작성했습니다 — 그 과정에서 이상 로그를 발견했습니다.",
    ...
    "Analyzed 2D evaluation experiment logs across all four codecs, reviewed CRF items and diffusion-model evaluation metrics, and ran worst-case and qualitative evaluation to see where restoration quality actually broke down.": "4개 코덱 전반의 2D 평가 실험 로그를 분석하고, CRF 항목과 확산 모델 평가 지표를 정리했으며, Worst-Case 분석과 정성 평가를 통해 복원 품질이 실제로 어디서 무너지는지 확인했습니다.",
    "Log analysis": "로그 분석",
