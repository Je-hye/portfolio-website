(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "Contact": "연락처",
    "Menu": "메뉴",
    "AI-native backend / systems engineer": "AI-native Backend · Systems Engineer",
    "I build systems": "마찰을",
    "that turn": "흐름으로 바꾸는",
    "friction": "시스템을",
    "into flow.": "만듭니다.",
    ...
    "Explore selected work": "주요 작업 살펴보기",
    "Start a conversation": "이야기 시작하기",
    "Currently": "현재",
    ...
    "#resilience": "#회복탄력성",
    "#technical-service": "#기술서비스직",
    "[ 02 — SELECTED SYSTEMS ]": "[ 02 — 주요 시스템 ]",
    "Built like a": "살아 움직이는",
    "living board.": "보드처럼.",
    "Tap or hover each pin to reveal the design decision behind the build.": "각 핀을 터치하거나 커서를 올려 구현 뒤의 설계 판단을 확인해 보세요.",
    "ONGOING": "진행 중",
    ...
    "Made specification readiness a prerequisite after identifying the risk of tests getting ahead of unresolved functional requirements.": "기능 요구사항이 확정되기 전에 테스트가 앞서가는 순서 리스크를 발견하고, 스펙 확정을 테스트 준비의 선행 조건으로 고정했습니다.",
    "SOLO BUILD": "1인 제작",
    "AI hierarchical to-do service": "AI 기반 계층형 Todo 서비스",
    ...
    "Restricted LLM calls to parse and decompose; scheduling stays deterministic for lower cost and predictable output.": "비용과 결과의 예측 가능성을 위해 LLM 호출은 parse·decompose에만 사용하고 schedule은 결정론적 로직으로 설계했습니다.",
    "Four focused agents + a resumable PM → Engineer → Reviewer → QA development loop.": "목적이 분명한 에이전트 4종과 중단 후에도 재개할 수 있는 PM → Engineer → Reviewer → QA 개발 루프입니다.",
    "AWARD": "수상작",
    "PM + Backend · team of 2": "PM + Backend · 2인 팀",
    "A multilingual assistant with internal terminology lookup, LLM fallback, and a self-growing knowledge base.": "교내 용어 검색, LLM fallback, 스스로 확장되는 지식 베이스를 결합한 다국어 AI 어시스턴트입니다.",
    ...
    "Ildan-Shim": "일단 쉼",
    "Planning + Frontend · team of 3": "기획 + Frontend · 3인 팀",
    "A stress-tagging AI scheduler with secure backend OAuth delegation and real-time SSE notifications.": "안전한 Backend OAuth 위임과 SSE 실시간 알림을 갖춘 스트레스 태깅 AI 스케줄러입니다.",
    "DEBUG NOTE": "디버그 노트",
    ...
    "Clear roles, persisted state, explicit handoffs, and limited rework cycles keep multi-agent workflows inspectable.": "명확한 역할, 지속되는 상태, 명시적인 handoff, 제한된 재작업 횟수로 멀티에이전트 워크플로우를 추적 가능한 상태로 유지합니다.",
    ...
    "BUILT WITH CURIOSITY + SYSTEMS THINKING": "호기심과 시스템 사고로 만들었습니다"
  }));

  document.documentElement.lang = "ko";
  document.body.dataset.lang = "ko";
  document.title = "정은혜 — AI Systems Engineer";
  const description = document.querySelector('meta[name="description"]');
  if (description) description.content = "멀티에이전트 워크플로우, 연구 도구, 실용적인 자동화를 설계하고 구축하는 정은혜의 AI-native Backend·Systems 포트폴리오.";
