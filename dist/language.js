(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "KNU Video Intelligence Lab": "KNU Video Intelligence Lab",
    "[ 01 — POINT OF VIEW ]": "[ 01 — 관점 ]",
    "“I keep a record of everything, then redesign the structure from that record.”": "“기록을 남기고, 그 기록에서 구조를 다시 설계합니다.”",
    "Rather than relying on willpower alone, I keep a full record of every problem and decision I run into along the way. I use that record to redesign structure and flow, automate whatever keeps repeating, and leave the important judgment calls to a person. I hold AI tools to that same standard.": "의지만 믿기보다, 과정에서 마주친 문제와 판단을 빠짐없이 기록합니다. 그 기록을 근거로 구조와 흐름을 다시 설계하고, 반복되는 불편은 자동화하되 중요한 판단은 사람에게 남깁니다. AI 도구를 쓸 때도 이 원칙을 그대로 적용합니다.",
    "#resilience": "#회복탄력성",
    ...
    "my-ai-agents' review loop now resumes from its last checkpoint, every agent runs on a cron schedule instead of manual triggers, and it triages Gmail into five priority tiers before writing the daily briefing — none of that was the original ask. The Video Codec Analysis Pipeline gained a fifth visualization stage the comparison never asked for.": "my-ai-agents의 리뷰 루프는 이제 마지막 체크포인트부터 재개되고, 모든 에이전트가 수동 실행이 아니라 Cron 스케줄로 돌아가며, 매일 브리핑을 쓰기 전에 Gmail을 5단계 우선순위로 분류합니다 — 원래 요청받았던 범위는 아니었습니다. Video Codec Analysis Pipeline은 비교 작업에서 요구되지도 않았던 다섯 번째 시각화 단계를 스스로 추가했습니다.",
    ...
    "Data Station Academy": "데이터스테이션 아카데미",
    ...
    "First Prize": "최우수상",
    "· Applied Python Data Analysis · Data Station Academy · 2024": "· Python 활용 실무 데이터 분석 · 데이터스테이션 아카데미 · 2024",
    ...
    "[ 04 — AI-NATIVE DEVELOPMENT ]": "[ 04 — AI 네이티브 개발 ]",
    "HOW I ACTUALLY WORK WITH AI": "AI와 실제로 협업하는 방식",
    "Judge whether this will repeat.": "이 작업이 반복될지 먼저 판단합니다.",
    "Build the harness or skill first — before writing the actual work.": "실제 작업에 들어가기 전에 하네스나 스킬부터 만듭니다.",
    "Magic Academy — designed the team's AI collaboration system (Claude Teams) before writing a single feature": "Magic Academy — 기능을 만들기 전에 팀의 AI 협업 체계(Claude Teams)부터 설계했습니다",
    "VCIP paper trimming — set the working harness and principles before the actual condensing work": "VCIP 논문 축약 — 실제 축약 작업 전에 작업 하네스와 원칙부터 세웠습니다",
    "Daily repeat tasks — turned into reusable skills instead of re-prompted from scratch each time": "일상 반복 업무 — 매번 새로 요청하지 않고 재사용 가능한 스킬로 만들어 둡니다",
    "my-ai-agents — this exact pattern, built into a tool of its own": "my-ai-agents — 이 패턴 자체를 도구로 만든 결과물입니다",
    "Delegate the real work on top of it — scoped by the harness.": "그 위에서 실제 작업을 위임합니다 — 범위는 하네스가 제한합니다.",
    "↓ Bound the agent": "↓ 에이전트의 경계를 정합니다",
    "Design so repeated runs stay safe.": "반복 실행에도 안전하도록 설계합니다.",
    "↓ Design for failure": "↓ 실패를 전제로 설계합니다",
    "Keep the final call human.": "최종 판단은 사람이 맡습니다.",
    "↓ Keep judgment human": "↓ 판단은 사람에게 남깁니다",
    "Before I hand something to AI, I make sure the work itself is a repeatable system first — the same principle as the hero: design the system, not the willpower.": "AI에게 맡기기 전에, 먼저 그 작업 자체가 반복 가능한 시스템이 되도록 만듭니다 — 의지가 아니라 구조를 설계한다는 Hero의 원칙과 같습니다.",
    "On Magic Academy's FE workflow, AI drafts the spec-based implementation — the developer still runs it, tests it, reviews it, and is the one who merges it.": "Magic Academy의 FE 워크플로우에서 AI는 스펙 기반 구현 초안을 작성하고, 실행·테스트·리뷰, 그리고 최종 머지는 여전히 담당 개발자가 맡습니다.",
    "Event Master Agent escalates to a human after two consecutive parse failures instead of guessing; dev-loop gates approval at the spec and PR steps; Magic Academy decides when AI needs sign-off with one rule — is it irreversible, out of scope, or externally visible.": "Magic Academy에서 Event Master Agent는 추측 대신 2회 연속 파싱 실패 시 사람에게 에스컬레이션하고, dev-loop는 스펙과 PR 단계에서 승인 게이트를 두며, Magic Academy는 되돌릴 수 없는지·범위를 벗어났는지·외부에 노출되는지 한 가지 기준으로 AI 승인 필요 여부를 판단합니다.",
    "Same logic behind the CompMVR security response — a pre-tool-use hook, a pre-commit hook, and a": "CompMVR 보안 대응과 같은 논리입니다 — pre-tool-use 훅과 pre-commit 훅, 그리고",
    "template that structurally limit what AI can touch, instead of trusting it to know better.": "템플릿으로, AI가 알아서 잘 하리라 믿는 대신 접근 가능한 범위 자체를 구조적으로 제한합니다.",
