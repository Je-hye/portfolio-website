(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "Designed a five-week AI course for instructors, covering prompt design, output evaluation, data safety, and subagent automation.": "강사를 대상으로 프롬프트 설계, 결과 평가, 데이터 안전, 서브에이전트 자동화를 다루는 5주 AI 수업을 구성했습니다.",
    "[ 07 — TRAJECTORY ]": "[ 07 — 여정 ]",
